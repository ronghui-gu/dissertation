...
As shown in
Figure~\ref{fig:base:sm:layers}, the shared memory management  consists of 2 layers: 1) getter-setter layer \verb"MShareIntro"
...
2) abs-kernel-fun layer \verb"MShare"
...
\regs' = \regs\leftarrow a.\comm{kctxp}(rtid)  
}{
\Gamma\vdash_{\comm{Asm}}  \spec_{\code{kctx\_switch}}([\ttid\cons \mathit{rtid}],\regs, m, a, 0, \regs',  m, a')
}
\end{mathpar}%
