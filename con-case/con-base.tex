...
Shared queue object
is widely used in concurrent kernels, e.g., as buffers for producer/consumer,
...
The {\cCTOS} kernel also provides a set of \emph{sleeping queues} \code{SleepQs}, which are
