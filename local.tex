...
\newcommand{\error}[0]{\code{ERROR}}
\newcommand{\ttid}[0]{\mathit{tid}}
\newcommand{\zhong}[1]{\textbf{\textcolor{red}{[ #1 --Zhong]}}}
%\newcommand{\ronghui}[1]{\textbf{\textcolor{blue}{[ #1 --Ronghui]}}}
%\newcommand{\adam}[1]{\textbf{\textcolor{red}{[ #1 --Adam]}}}
...
\newcommand\incticket{\code{FAI\_ticket}}
\newcommand\incnow{\code{inc\_now}}
\newcommand\getnow{\code{get\_now}}
\newcommand\tshared{\code{tshared}}
\newcommand\holdlock{\code{hold\_lock}}
...
\newcommand\ttlockop{\code{TTLockOp}}
\newcommand\ttlock{\code{TTLock}}
\newcommand\pkctxop{\code{PKCtxOp}}
\newcommand\pqintro{\code{PQIntro}}
\newcommand\pqueue{\code{PQueue}}
\newcommand\pthread{\code{PThread}}
\newcommand\phthread{\code{PHThread}}
\newcommand\lthread{\code{LThread}}
