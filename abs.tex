...
However, modern OS kernels are complex and consist of a multitude of abstraction layers,
which have mostly been treated as a system
concept.
Despite their obvious
importance, abstraction layers have almost never been formally specified or
...
What's more, concurrent abstraction layers are ubiquitous in OS kernels because of the pervasiveness of multi-threaded programming and
multi-core hardware. This severely limits the applicability of
...
formal proofs of functional correctness for simplegeneral-purpose
...
\CTOS{} provides a new layer
calculus. 
This thesis shows how to instantiate the layer calculus in
