...
What's more, concurrent abstraction layers are ubiquitous in OS kernels because of the pervasiveness of multithreaded programming and
multicore hardware. This severely limits the applicability of
